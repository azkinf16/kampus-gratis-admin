    ...
    <div className="flex flex-col p-[10px] px-4">
      <div className="flex flex-col justify-between gap-y-6">
        <div className="flex justify-between w-full ">
          <p className={`text[12px] bg-[#E3FBDA] font-semibold px-3  w-auto rounded-md`}>#softskills</p>
          <p className="flex text-[12px] text-neutral-500 justify-center items-center">
          #softskills
          </p>
        </div>
        <div>
          <h1 className="text-black font-bold text-[18px]">Masih Sering Gugup Saat Public Speaking? Terapin 6 Tips Ampuh Ini!</h1>
        </div>
      </div>
    </div>
