...
const PartnerSection = () => {
  const _partner_logo = [Partner1, Partner2, Partner3, Partner4, Partner5, Partner6, Partner7, Partner8];
  ...
  return (
    <section className='lg:flex flex-col pt-20 px-8 text-center'>
       <h1 className="font-bold text-[36px] leading-none mb-8">Mitra <span className='text-red-base'>Kampus Kami</span></h1>
