...
const AdvantageSection: FC = () => {
  return (
   <section className='w-full lg:flex px-8 py-5'>
    <div className="w-full lg:w-1/2 lg py-5 md:flex md:justify-center lg:justify-start">
        <img src="images/advantage-image.png" alt="" />
    </div>
    <div className="w-full lg:w-1/2 lg:block md:flex lg:my-auto">
        ...
        <h1 className='text-2xl md:text-4xl block font-semibold'>Mengapa <span className='lg:text-5xl text-4xl  block font-bold text-orange-base'>Kampus Gratis?</span></h1>
        </div>
        <div className='mt-4 text-md w-full md:w-1/2 lg:w-full'>
        <p className='text-md text-neutral-600 lg:my-4 my-2'>Ada banyak kategori pelatihan terlaris yang ada di Kampus Gratis</p>
