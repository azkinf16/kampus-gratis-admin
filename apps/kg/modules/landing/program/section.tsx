...
const ProgramSection = () => {
  ...
  <SwiperSlide className="flex justify-center">
    ...
    <Button type="button" className='text-white border-2 border-blue-base bg-blue-base py-3 px-4 font-semibold text-sm rounded-lg flex justify-between items-center'>Selanjutnya <img src="icons/right-arrow-white.svg" alt="" className='pl-2 w-6' /> </Button>
      </div>
    </section>
  )
}
